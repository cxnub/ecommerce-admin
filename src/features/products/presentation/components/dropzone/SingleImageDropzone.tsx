...
export default function SingleImageDropzone({ loading, onDrop }: ImageDropzoneProps) {
  ...
  return (
    <div className={classes.wrapper}>
      <Dropzone
        ...
        maxSize={30 * 1024 ** 2}
        loading={loading}
        loaderProps={{children: <CustomOverlayLoader text="Analyzing product image..." />}}
      >
        <div style={{ pointerEvents: "none" }}>
          ...
          <Text ta="center" fz="sm" mt="xs" c="dimmed">
            Drag&apos;n&apos;drop an image of your new product and we'll take
            care of the rest!
            <br />
